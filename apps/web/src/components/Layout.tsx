...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="tm-app-bg min-h-screen text-white">
      {/* Top bar */}
      <header className="sticky top-0 z-20 fp-top-nav text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            {user ? (
              <button
                type="button"
                className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-amber-100/15 bg-white/[0.075] text-white shadow-sm md:hidden"
            ...
            {desktopMenuOpen ? (
              ...
              >
                <div className="p-2">
                  ...
                  <div className="my-2 h-px bg-white/[0.075]" />
              ...
              <>
                {approved.length > 1 ? (
                  <div className="hidden md:flex items-center gap-2">
                    <select
                      className="rounded-xl border border-amber-100/15 bg-[#07150f]/80 px-3 py-2 text-sm text-white"
      ...
      {user && drawerOpen ? (
        <div className="fixed inset-0 z-30 md:hidden">
          <div className="absolute inset-0 bg-black/55" onClick={() => setDrawerOpen(false)} aria-hidden="true" />
      ...
      <main className={`relative mx-auto max-w-6xl px-4 py-6 ${mobileMainTabsVisible ? "pb-24 md:pb-6" : ""}`}>
        {switchingLeague ? (
          <div className="absolute inset-0 z-20 flex items-start justify-center bg-[#07150f]/80 pt-6 backdrop-blur-sm">
            <div className="flex items-center gap-3 rounded-2xl border border-amber-100/15 bg-[#07150f]/90 px-4 py-3 shadow-sm">
              <Spinner />
      ...
      {mobileMainTabsVisible ? (
        <nav className="tm-mobile-bottom-nav fp-bottom-nav tm-glass-sheet md:hidden">
          <div
