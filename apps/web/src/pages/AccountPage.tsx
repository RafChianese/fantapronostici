    ...
    <div className="mx-auto max-w-2xl space-y-6">
        ...
        <Card>
          ...
          <CardContent className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-orange-50/60">Codice: {activeLeague.code}</div>
            </div>
          </CardContent>
        </Card>
      ) : null}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-4 rounded-2xl border border-amber-100/15 bg-[#07150f]/80 p-4">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-orange-50/60">Seleziona un avatar qui sotto e salva.</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 sm:grid-cols-5">
            {AVATARS.map((a) => {
              ...
              return (
                ...
                >
                  <div className="h-20 w-full overflow-hidden rounded-xl bg-white/[0.055] ring-1 ring-slate-800">
